jQuery( function( $ ) {
	...
	// Demo importer wizard start.
		...
		// Set title.
		$( '.xtra-wizard-selected strong' ).html( args.demo );
	...
	// RTL demo preview.
		...
		$( '.xtra-demo-image' ).attr( 'src', $( this ).is( ':checked' ) ? args.image.replace( args.demo, 'rtl/' + args.demo ) : args.image );
	...
	// Uninstall demo after confirm.
		...
		done.html( done.html().replace( 'DEMONAME', demo ) );
