 ...
 */
class Xtra_Elementor_Control_StyleKit_Pro extends \Elementor\Control_Base_Multiple {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'xtra-elementor-stylekit-pro', Codevz_Plus::$url . 'elementor/assets/js/stylekit_pro.js', [], Codevz_Plus::$ver, false );
