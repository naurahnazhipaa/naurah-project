...
class Codevz_Plus {
	...
	public static function wp_enqueue_scripts() {
		...
		wp_register_script( 'cz_title', 			self::$url . 'wpbakery/assets/js/title.js', [ 'codevz-plugin' ], self::$ver, true );
		...
		if ( self::option( 'magic_mouse' ) ) {
			...
			wp_enqueue_script( 'codevz-magic-mouse', 		self::$url . 'assets/js/magic-mouse.js', [ 'codevz-plugin' ], self::$ver, true );
		...
		if ( ! self::option( 'disable_responsive' ) ) {
			...
			wp_enqueue_style( 'codevz-plugin-tablet', self::$url . 'assets/css/codevzplus-tablet.css', [ 'codevz-plugin' ], self::$ver, 'screen and (max-width: ' . self::option( 'tablet_breakpoint', '768px' ) . ')' );
			wp_enqueue_style( 'codevz-plugin-mobile', self::$url . 'assets/css/codevzplus-mobile.css', [ 'codevz-plugin' ], self::$ver, 'screen and (max-width: ' . self::option( 'mobile_breakpoint', '480px' ) . ')' );
	...
	public function admin_notices() {
		...
		if ( ( $name === 'XTRA' || $name === 'XTRA Child' || $name === 'Xtra' || $name === 'Xtra Child' ) && self::$ver != $ver ) {
			...
			if ( version_compare( $ver, self::$ver, '<' ) ) {
				...
				?>
					<div class="notice notice-warning is-dismissible">
						...
						<a href="?xtra_notice_dismiss" class="notice-dismiss"><span class="screen-reader-text"><?php esc_html_e( 'Dismiss this notice.', 'codevz' ); ?></span></a>
					</div>
				<?php
